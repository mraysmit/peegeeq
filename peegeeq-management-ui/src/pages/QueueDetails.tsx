...
const QueueDetails = () => {
    ...
    const fetchQueueDetails = async () => {
        ...
        try {
            ...
            const response = await axios.get(getVersionedApiUrl(`queues/${setupId}/${actualQueueName}`))
    ...
    const fetchConsumers = async () => {
        ...
        try {
            ...
            const [setupId, actualQueueName] = parts
            const response = await axios.get(getVersionedApiUrl(`queues/${setupId}/${actualQueueName}/consumers`))
    ...
    const fetchBindings = async () => {
        ...
        try {
            ...
            const [setupId, actualQueueName] = parts
            const response = await axios.get(getVersionedApiUrl(`queues/${setupId}/${actualQueueName}/bindings`))
    ...
    const handleGetMessages = async () => {
        try {
            ...
            const response = await axios.get(getVersionedApiUrl(`queues/${setupId}/${actualQueueName}/messages`), {
                params: {
                    count: values.count,
    ...
    const handlePublishMessage = async () => {
        try {
            ...
            const response = await axios.post(getVersionedApiUrl(`queues/${setupId}/${actualQueueName}/publish`), {
                payload,
        ...
        Modal.confirm({
            ...
            onOk: async () => {
                try {
                    ...
                    await axios.post(getVersionedApiUrl(`queues/${setupId}/${actualQueueName}/purge`))
