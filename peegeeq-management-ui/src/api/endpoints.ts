...
export const MANAGEMENT_ENDPOINTS = {
    ...
    /** GET - List all event stores across all setups */
    EVENT_STORES: `${API_V1_PREFIX}/management/event-stores`,
    /** POST - Create a new event store */
    CREATE_EVENT_STORE: `${API_V1_PREFIX}/management/event-stores`,
    /** DELETE - Delete an event store */
    DELETE_EVENT_STORE: (storeId: string) => `${API_V1_PREFIX}/management/event-stores/${storeId}`,
