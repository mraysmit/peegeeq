...
**Purpose**: Permanently delete a queue and all its messages
**Path Parameters**:
- `setupId`: Setup identifier
- `queueName`: Queue name
...
```json
{
  ...
  "setupId": "my-setup",
  "deletedMessages": 42,
  "timestamp": 1766555981037
}
```

**Alternative Endpoint**: `DELETE /api/management/queues/:setupId/:queueName`
**Alternative Endpoint**: `DELETE /api/v1/management/queues/:queueName`
**Alternative Endpoint**: `DELETE /api/v1/management/queues/:key`

**Used By**: `queuesApi.ts`, `QueueDetailsEnhanced.tsx`, `Queues.tsx`, `apiHelpers.ts`

**Implementation Locations**:
- Backend: `peegeeq-rest/src/main/java/dev/mars/peegeeq/rest/handlers/ManagementApiHandler.java` (deleteQueueByName method)
- Frontend: `src/pages/QueueDetailsEnhanced.tsx` (handleDeleteQueue function)
- Test: `peegeeq-rest/src/test/java/dev/mars/peegeeq/rest/handlers/QueueDeleteManualTest.java`
- API: `src/store/api/queuesApi.ts:114-140` (within performQueueOperation)
- Legacy: `src/pages/Queues.tsx:110`
- Test Helpers: `src/tests/fixtures/apiHelpers.ts:39`
...
**Used By**: `queuesApi.ts`, `QueueDetailsEnhanced.tsx`

**Implementation Locations**:
- Backend: `peegeeq-rest/src/main/java/dev/mars/peegeeq/rest/handlers/ManagementApiHandler.java` (pauseQueue method)
- Frontend: `src/pages/QueueDetailsEnhanced.tsx` (handlePauseResume function)
- Test: `peegeeq-rest/src/test/java/dev/mars/peegeeq/rest/handlers/QueuePauseResumeManualTest.java`
...
**Implementation Locations**:
- Backend: `peegeeq-rest/src/main/java/dev/mars/peegeeq/rest/handlers/ManagementApiHandler.java` (resumeQueue method)
- Frontend: `src/pages/QueueDetailsEnhanced.tsx` (handlePauseResume function)
- Test: `peegeeq-rest/src/test/java/dev/mars/peegeeq/rest/handlers/QueuePauseResumeManualTest.java`
