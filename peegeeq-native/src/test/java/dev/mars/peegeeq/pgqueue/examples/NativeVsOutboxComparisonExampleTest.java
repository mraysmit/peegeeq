...
class NativeVsOutboxComparisonExampleTest {
    ...
    private void demonstratePerformanceCharacteristics() {
        ...
        logger.info("    Latency: Moderate (seconds to minutes)");
        ...
        logger.info("    Trade-off: Speed vs Reliability");
    }
    ...
    private void demonstrateFailureScenarios() {
        ...
        logger.info("    Native LISTEN/NOTIFY:");
        logger.info("       May overwhelm slow consumers");
        logger.info("       No built-in backpressure mechanism");
        logger.info("       Risk of connection timeouts");
        logger.info("    Outbox Pattern:");
