...
public class DatabaseConfig {
    ...
    public DatabaseConfig(String host, int port, String databaseName, String username,
                         String password, String schema, boolean sslEnabled,
                         String templateDatabase, String encoding, ConnectionPoolConfig poolConfig) {
        this.host = host;
        this.port = port;
