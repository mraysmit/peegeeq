...
public class QueuePauseResumeManualTest {

    private static final Logger logger = LoggerFactory.getLogger(QueuePauseResumeManualTest.class);
    private static final int TEST_PORT = 18099;

    @Container
    static PostgreSQLContainer<?> postgres = new PostgreSQLContainer<>(PostgreSQLTestConstants.POSTGRES_IMAGE)
            .withDatabaseName("peegeeq_pause_test")
