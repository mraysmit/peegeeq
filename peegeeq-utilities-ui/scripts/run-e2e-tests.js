 ...
 * 1. Killing any existing dev server on port 3001
 * 2. Running Playwright tests (Playwright starts the dev server via webServer config)
 * 3. Cleaning up after tests complete
 */
